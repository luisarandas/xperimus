...
document.body.onkeyup = function(e){
  ...
  if (e.keyCode == 49) {
    ...
    if ($('#first-page').position().left == 0) {
      $('#first-page').animate({right: _w}, "fast");
      $('#first-page').each(function(){
        $(this).animate({right: _w}, "fast");
      });
      $('#second-page').animate({left: 0}, "fast");
      $('#second-page').each(function(){
        $(this).animate({left: 0}, "fast");
      });
    } else {
      $('#first-page').animate({right: 0}, "fast");
      $('#first-page').each(function(){
        $(this).animate({right: 0}, "fast");
      });
      $('#second-page').animate({left: _w}, "fast");
      $('#second-page').each(function(){
        $(this).animate({left: _w}, "fast");
      });
    }
  }
...
console.log("make splash screen");
